...
export default {
  ...
  "setting.general.mobile_toast_top": "알림 표시 위치",
  "setting.general.mobile_toast_top_desc": "모바일 기기에서 알림 토스트의 화면 상단으로부터의 거리(px). 기본값: 폰 110, 태블릿 126.",
  ...
  "ui.menu.clear_hash": "파일 해시 매핑 정리",
